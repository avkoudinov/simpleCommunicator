...
begin:/^\.\.\.(?=[ ]|$)/}]}]})})());hljs.registerLanguage("rust",(()=>{"use strict";function e(...e){
...
end:"$",illegal:"\n"},o]}}})());hljs.registerLanguage("powershell",(()=>{"use strict";return e=>{const n={
$pattern:/-?[A-z\.\-]+\b/,
...
begin:"@[A-Za-z]+"}]}}})());hljs.registerLanguage("csharp",(()=>{"use strict";return e=>{const n={
...
end:/[^\\](?=\s*$)/,subLanguage:"bash"}}]})})());hljs.registerLanguage("pgsql",(()=>{"use strict";return E=>{
...
relevance:0}]}}})());hljs.registerLanguage("scss",(()=>{"use strict"
...
end:/$/}]})})());hljs.registerLanguage("vbnet",(()=>{"use strict";function e(e){
return e?"string"==typeof e?e:e.source:null}function n(...n){
return n.map((n=>e(n))).join("")}function t(...n){return"("+((e=>{
const n=e[e.length-1]
;return"object"==typeof n&&n.constructor===Object?(e.splice(e.length-1,1),n):{}
...
starts:{end:/$/,contains:[t,l,r,i,c,a]}}]}}})());hljs.registerLanguage("javascript",(()=>{"use strict"
