...
class Zend_Http_Client
{
    ...
    public function setMethod($method = self::GET)
    {
        ...
        if (($method == self::POST || $method == self::PUT || $method == self::PATCH || $method == self::DELETE) && $this->enctype === null) {
    ...
    protected function _prepareHeaders()
    {
        ...
        if (($this->method == self::POST || $this->method == self::PATCH || $this->method == self::PUT) &&
    ...
    protected function _prepareBody()
    {
        ...
        if ($body || $this->method == self::POST || $this->method == self::PATCH || $this->method == self::PUT) {
