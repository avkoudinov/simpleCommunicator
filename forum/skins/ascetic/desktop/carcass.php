...
.author_cell .author_actions img
{
...
<span class="title_appendix_text" title="Debug Console" onclick='show_debug_console(true)'>&nbsp;(аскет) <?php if(!empty($_SESSION["admdebug"])) echo "[debug]"; ?></span>
</div>
