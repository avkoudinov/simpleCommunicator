...
<td><span class="number"><?php echo_html(text("SkinSettings")); ?>:</span></td>
</tr>
<tr class="skin_property skin_property_<?php echo_html($skin); ?>" style="display: <?php echo($skin == $user_data["skin"] ? "table-row" : "none"); ?>">
<td>
...
<div class="field_comment"><?php echo_html(text("NotifyOnWordsComment")); ?></div>
   ...
   <tr style="display:none">
     <td>
     <input type="hidden" id="donot_notify_on_rates" name="donot_notify_on_rates" value="1"> 
     </td>
     <td>
     </td>
   </tr>
...
<div class="field_comment"><?php echo_html(text("CustomSmilesComment")); ?></div></td>
</tr>
...
<tr>
<th class="subheader"><?php echo_html(text("Block")); ?></th>
</tr>

<tr>
<td><span class="number"><?php echo_html(text("Period")); ?>:</span></td>
</tr>
<tr>
<td>
