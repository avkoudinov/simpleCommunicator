...
<a href="<?php echo($base_url); ?>&do_search=1&show_deep_replies=1&hash=<?php echo_html($_SESSION["hash"]); ?>" onclick="check_actual_hash(this)" class="moderator_link"><?php echo_html(text("ShowAllReplies")); ?></a> <br>
<?php else: ?>
<a href="<?php echo($base_url); ?>&do_search=1&show_direct_replies=1&hash=<?php echo_html($_SESSION["hash"]); ?>" onclick="check_actual_hash(this)" class="moderator_link"><?php echo_html(text("ShowDirectReplies")); ?></a> <br>
<?php endif; ?>
<?php endif; ?>
