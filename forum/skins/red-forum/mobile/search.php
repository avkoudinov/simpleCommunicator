...
<table class="topic_table">
  ...
  <?php if (count($topic_list) == 0): ?>
      ...
      <tr>
          <td class="table_message" colspan="2"><?php echo_html(text("NoTopicsFound")); ?></td>
      </tr>
...
<table class="form_table search_table">
  ...
  <tr>
      <th><?php echo_html(text("SearchCriteria")); ?></th>
  </tr>
  ...
  <tr>
     ...
     <table class="checkbox_table">
         ...
         <tr>
          ...
          <input type="text" id="author" name="author" maxlength="250" value="<?php echo_html(reqvar("author")); ?>" autocomplete="off" 
          ...
          <td style="width:1%"><button class="me_button" onclick="set_to_me();" type="button"><?php echo_html(text("Me")); ?></button></td>
          </tr>
          </table>
          ...
          <select multiple name="forums[]" id="forums" class="search_forum_select multiple_choice">
