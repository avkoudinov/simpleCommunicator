...
function show_hide_password()
{
  ...
  if(!row1 || !row2 || !protected_by_password) return;
...
function show_hide_restrictions()
{
  ...
  if(!row3 || !no_guests || !registered_access || !protected_by_password || !restricted_access) return;
...
/ <span class="topic_title_main"><?php echo_html(text("EditForum")); ?></span>
</div>
...
<tr>
<th colspan="2"><?php echo_html(reqvar_empty("fid") ? text("CreateForum") : text("EditForum")); ?></th>
</tr>

<tr>
<td><?php echo_html(text("Name")); ?>*:</td>
<td><input type="text" id="forum_name" name="forum_name" value="<?php echo_html(val_or_empty($forum_data["forum_name"])); ?>" autocomplete="off"></td>
</tr>

<tr>
<td style="vertical-align:top"><?php echo_html(text("Description")); ?>:</td>
<td><textarea id="forum_description" name="forum_description"><?php echo_html(val_or_empty($forum_data["forum_description"])); ?></textarea></td>
</tr>
...
<tr>
<th colspan="2"><?php echo_html(text("Moderators")); ?></th>
</tr>
