...
<div class="title_appendix"><span class="title_appendix_text" title="Debug Console" onclick='show_debug_console(true)'>&nbsp;(скруль) <?php if(!empty($_SESSION["admdebug"])) echo "[debug]"; ?></span></div>
