...
<tr>
<th><?php echo_html(text("BotProfile")); ?></th>
</tr>
...
<tr>
  ...
  ?>
<td><span class="number"><?php echo_html($fmanager->get_display_name($bot_data["user_name"])); ?></span><?php echo($online_status); ?></td>
</tr>
...
<tr>
<td><?php echo_html(text("LastActivity")); ?>: <span class="number"><?php echo_html($bot_data["last_visit_date"]); ?></span></td>
</tr>
