...
<tr>
<td class="table_message"><?php echo_html(text("ReadmarkersNotFound")); ?></td>
</tr>
...
<td>
  ...
  <div class="forum_info">
  <?php echo_html(text("UserAgent")); ?>: <span class="number"><?php echo_html($rm_data["user_agent"]); ?></span><br>

  <?php echo_html(text("Views")); ?>: <span class="number"><?php echo_html(format_number($rm_data["hits"])); ?> / <?php echo_html(format_number($rm_data["current_name_hits"])); ?></span><br>

  <?php echo_html(text("FirstActivity")); ?>: <span class="number"><?php echo_html($rm_data["first_activity"]); ?> / <?php echo_html($rm_data["current_name_start"]); ?></span><br>
  <?php echo_html(text("LastActivity")); ?>: <span class="number"><?php echo_html($rm_data["last_activity"]); ?></span><br>
  </div>
...
<?php if(count($read_marker_list) > 2): ?>
