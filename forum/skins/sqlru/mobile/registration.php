...
<tr>
<th><?php echo_html(text("Registration")); ?></th>
</tr>
...
<tr>
<td>
<input type="checkbox" id="hide_email" name="hide_email" checked> <label for="hide_email"><?php echo_html(text("HideEmail")); ?></label>
</td>
</tr>
...
<td>
   ...
   <tr>
     ...
     <td>
     <label for="rules_agreemnt" class="rules_agreemnt"><?php echo(text("RegistrationRulesAgreement")); ?></label>
     </td>
   </tr>
   </table>
</td>
...
<tr>
<td><div class="field_comment"><?php echo_html(text("RegistrationComment")); ?></div></td>
</tr>
