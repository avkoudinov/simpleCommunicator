...
| <a href="events.php" onclick='return confirm_action("<?php echo_js(text("MsgConfirmMarkDone"), true); ?>", { mark_events_done: 1, uncritical: 1 })'><?php echo_html(text("MarkDone")); ?></a>
</div>
...
<tr>
<th><?php echo_html(text("Author")); ?></th>
...
<tr>
<td colspan="3" class="table_message"><?php echo_html(text("NoEvents")); ?></td>
</tr>
...
?>
<td><div class="smart_break"><?php echo($evinfo["author"]); ?><?php echo($online_status); ?></div></td>
...
<?php echo($evinfo["event"]); ?>
</div>
</td>
<td><?php echo_html($evinfo["event_time"]); ?></td>
</tr>
