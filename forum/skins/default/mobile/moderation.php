...
<tr>
<th><?php echo_html(text("Moderation")); ?></th>
</tr>
...
<tr>
<td>
<a href="ip_moderation.php?type=moderation&ip=<?php echo(xrawurlencode(reqvar("ip"))); ?>" onclick="return moderate_ip(this)"><?php echo_html(text("ModerateIP")); ?></a>
</td>
</tr>
...
<tr>
<th><?php echo_html(text("BulkDeletion")); ?></th>
</tr>
...
<tr>
<th class="subheader"><?php echo_html(text("Members")); ?></th>
</tr>
