...
function select_target_topic_for_merge()
{
  ...
  Forum.show_topic_selector("<?php echo_js(text("MergeTopic")); ?>", buttons, false, true, 870);
...
function select_private_members()
{
  ...
  show_member_selector("search_member_area", "<?php echo_js(text("ManageMembers")); ?>", "<?php echo_js(text("TopicMembers")); ?>", buttons, 800);
...
function select_blocked_users()
{
  ...
  show_member_selector("search_blocked_user_area", "<?php echo_js(text("ManageMembers")); ?>", "<?php echo_js(text("BlockedUsers")); ?>", buttons, 800);
...
<span id="publish_topic"><a href="<?php echo($base_url); ?>" onclick='return confirm_action("<?php echo_js(text("MsgConfirmTopicPublish"), true); ?>", { topic_action: "publish", topic: "<?php echo_js($tid); ?>", forum: "<?php echo_js($fid); ?>" })'><?php echo_html(text("Publish")); ?></a> <br></span>
<?php endif; ?>

<?php if(empty($topic_data["in_favourites"])): ?>
<a id="favourites_action" href="<?php echo($base_url); ?>" onclick='return confirm_action("<?php echo_js(text("MsgConfrimAddToFavourites"), true); ?>", { topic_action: "add_to_favourites", topic: "<?php echo_js($tid); ?>", forum: "<?php echo_js($fid); ?>" })'><?php echo_html(text("AddToFavourites")); ?></a> <br>
<?php else: ?>
<a id="favourites_action" href="<?php echo($base_url); ?>" onclick='return do_action({ topic_action: "remove_from_favourites", topic: "<?php echo_js($tid); ?>", forum: "<?php echo_js($fid); ?>" })'><?php echo_html(text("RemoveFromFavourites")); ?></a> <br>
<?php endif; ?>

<?php if($fmanager->is_logged_in() && !$fmanager->is_master_admin()): ?>
  <?php if(empty($topic_data["subscribed"])): ?>
  <a id="subscribe_action" href="<?php echo($base_url); ?>" onclick='return confirm_action("<?php echo_js(text("MsgConfirmSubscribeToTopic"), true); ?>", { topic_action: "subscribe", topic: "<?php echo_js($tid); ?>", forum: "<?php echo_js($fid); ?>" })'><?php echo_html(text("Subscribe")); ?></a> <br>
  <?php else: ?>
  <a id="subscribe_action" href="<?php echo($base_url); ?>" onclick='return do_action({ topic_action: "unsubscribe", topic: "<?php echo_js($tid); ?>", forum: "<?php echo_js($fid); ?>" })'><?php echo_html(text("Unsubscribe")); ?></a> <br>
  <?php endif; ?>
<?php endif; ?>

<?php if(empty($topic_data["in_ignored"])): ?>
<a id="ignore_action" href="<?php echo($base_url); ?>" onclick='return confirm_action("<?php echo_js(text("MsgConfirmTopicIgnore"), true); ?>", { topic_action: "add_to_ignored", topic: "<?php echo_js($tid); ?>", forum: "<?php echo_js($fid); ?>" })'><?php echo_html(text("AddToIgnoredTopics")); ?></a> <br>
<?php else: ?>
<a id="ignore_action" href="<?php echo($base_url); ?>" onclick='return do_action({ topic_action: "remove_from_ignored", topic: "<?php echo_js($tid); ?>", forum: "<?php echo_js($fid); ?>" })'><?php echo_html(text("RemoveFromIgnoredTopics")); ?></a> <br>
<?php endif; ?>

<?php if(empty($topic_data["user_pinned"])): ?>
<a id="pin_user_action" href="<?php echo($base_url); ?>" onclick='return confirm_action("<?php echo_js(text("MsgConfirmPinTopic"), true); ?>", { topic_action: "pin_user_topic", topic: "<?php echo_js($tid); ?>", forum: "<?php echo_js($fid); ?>" })'><?php echo_html(text("PinTopic")); ?></a> <br>
<?php else: ?>
<a id="pin_user_action" href="<?php echo($base_url); ?>" onclick='return do_action({ topic_action: "unpin_user_topic", topic: "<?php echo_js($tid); ?>", forum: "<?php echo_js($fid); ?>" })'><?php echo_html(text("UnpinTopic")); ?></a> <br>
<?php endif; ?>

<a href="<?php echo($base_url); ?>" onclick='return confirm_action("<?php echo_js(text("MsgConfirmMarkRead"), true); ?>", { mark_read_action: "mark_topic_read", topic: "<?php echo_js($tid); ?>", uncritical: 1 })'><?php echo_html(text("MarkReadShort")); ?></a> / <a href="<?php echo($base_url); ?>" onclick='return confirm_action("<?php echo_js(text("MsgConfirmMarkUnread"), true); ?>", { mark_read_action: "mark_topic_unread", start_post: "<?php echo_js($first_message); ?>", uncritical: 1 })'><?php echo_html(text("MarkUnread")); ?></a><br>

<?php if($fmanager->is_logged_in()): ?>
<a href="<?php echo($base_url . $startmsg_appendix . "&download=1"); ?>"><?php echo_html(text("Download")); ?></a> <br>
<?php endif; ?>
...
<a href="<?php echo($base_url . $gotomsg_appendix); ?>&guest_posting_on=1&hash=<?php echo_html($_SESSION["hash"]); ?>" onclick="check_actual_hash(this)" class="moderator_link"><?php echo_html(text("GuestPostingModeOn")); ?></a><br>
<?php else: ?>
<a href="<?php echo($base_url . $gotomsg_appendix); ?>&guest_posting_off=1&hash=<?php echo_html($_SESSION["hash"]); ?>" onclick="check_actual_hash(this)" class="moderator_link"><?php echo_html(text("GuestPostingModeOff")); ?></a><br>
<?php endif; ?>
<?php endif; ?>

<?php if(!empty($topic_data["profiled_topic"])): ?>
<?php if(empty($topic_data["thematic_only"])): ?>
<a href="<?php echo(preg_replace("/&force_comments=1/", "", $base_url) . $startmsg_appendix); ?>&show_thematic_messages=1&hash=<?php echo_html($_SESSION["hash"]); ?>" onclick="check_actual_hash(this)" class="moderator_link"><?php echo_html(text("ThematicOnly")); ?></a><br>
<?php else: ?>
<a href="<?php echo(preg_replace("/&force_comments=1/", "", $base_url) . $startmsg_appendix); ?>&show_all_messages=1&hash=<?php echo_html($_SESSION["hash"]); ?>" onclick="check_actual_hash(this)" class="moderator_link"><?php echo_html(text("ShowAllMessages")); ?></a><br>
<?php endif; ?>
<?php endif; ?>

<?php echo_html(text("Filter")); ?>:<br>

<?php if($fmanager->get_user_name() != ""): ?>
<a href="search.php?do_search=1&tid=<?php echo_html($tid); ?>&author_mode=wrote_post&author=<?php echo(xrawurlencode($fmanager->get_user_name())); ?>&start_from=<?php echo($first_message); ?>"><?php echo_html(text("MyMessages")); ?></a> <br>
<?php endif; ?>

<a href="search.php?do_search=1&tid=<?php echo_html($tid); ?>&author_mode=wrote_post&author=<?php echo(xrawurlencode($topic_data["author"])); ?>&start_from=<?php echo($first_message); ?>"><?php echo_html(text("TopicAuthorMessages")); ?></a> <br>

<?php if(empty($_SESSION["hide_ignored"]) && $fmanager->has_ignored()): ?>
<a href="search.php?do_search=1&tid=<?php echo_html($tid); ?>&non_ignored_by_author=1&start_from=<?php echo($first_message); ?>"><?php echo_html(text("TopicNotIgnoredMessages")); ?></a> <br>
<?php endif; ?>

<a href="search.php?do_search=1&tid=<?php echo_html($tid); ?>&has_attachment=1&start_from=<?php echo($first_message); ?>"><?php echo_html(text("SearchAttachmentsOnly")); ?></a> <br>

<a href="search.php?do_search=1&tid=<?php echo_html($tid); ?>&has_picture=1&start_from=<?php echo($first_message); ?>"><?php echo_html(text("SearchPicturesOnly")); ?></a> <br>

<a href="search.php?do_search=1&tid=<?php echo_html($tid); ?>&has_video=1&start_from=<?php echo($first_message); ?>"><?php echo_html(text("SearchVideosOnly")); ?></a> <br>

<a href="search.php?do_search=1&tid=<?php echo_html($tid); ?>&has_audio=1&start_from=<?php echo($first_message); ?>"><?php echo_html(text("SearchAudioOnly")); ?></a> <br>

<a href="search.php?do_search=1&tid=<?php echo_html($tid); ?>&has_adult=1&start_from=<?php echo($first_message); ?>"><?php echo_html(text("SearchAdultOnly")); ?></a> <br>
...
<?php if(!empty($topic_data["is_private"])): ?>
  ...
  <a href="<?php echo($base_url . $gotomsg_appendix); ?>&show_deleted=1&hash=<?php echo_html($_SESSION["hash"]); ?>" onclick="check_actual_hash(this)" class="moderator_link"><?php echo_html(text("DisplayDeleted")); ?></a><br>
  <?php else: ?>
  <a href="<?php echo($base_url . $gotomsg_appendix); ?>&hide_deleted=1&hash=<?php echo_html($_SESSION["hash"]); ?>" onclick="check_actual_hash(this)" class="moderator_link"><?php echo_html(text("HideDeleted")); ?></a><br>
  <?php endif; ?>
  
  <?php if(empty($topic_data["deleted"])): ?>
  <a href="<?php echo($base_url); ?>" class="moderator_link" onclick='return confirm_action("<?php echo_js(text("MsgConfirmTopicDelete"), true); ?>", { topic_action: "delete_topic", topic: "<?php echo_js($tid); ?>", forum: "<?php echo_js($fid); ?>" });'><?php echo_html(text("DeleteTopic")); ?></a><br>
  <?php else: ?>
  <a href="<?php echo($base_url); ?>" class="moderator_link" onclick='return do_action({ topic_action: "restore_topic", topic: "<?php echo_js($tid); ?>", forum: "<?php echo_js($fid); ?>" })'><?php echo_html(text("RestoreTopic")); ?></a><br>
  <?php endif; ?>
  
  <?php if(empty($topic_data["closed"])): ?>
  <a href="<?php echo($base_url); ?>" class="moderator_link" onclick='return confirm_action("<?php echo_js(text("MsgConfirmTopicClose"), true); ?>", { topic_action: "close_topic", topic: "<?php echo_js($tid); ?>", forum: "<?php echo_js($fid); ?>" });'><?php echo_html(text("CloseTopic")); ?></a><br>
  <?php else: ?>
  <a href="<?php echo($base_url); ?>" class="moderator_link" onclick='return do_action({ topic_action: "open_topic", topic: "<?php echo_js($tid); ?>", forum: "<?php echo_js($fid); ?>" })'><?php echo_html(text("OpenTopic")); ?></a><br>
  <?php endif; ?>
  <?php endif; // if topic moderator ?>
  
  <?php if($topic_data["user_id"] == $fmanager->get_user_id() && $topic_data["is_private"] == 2): ?>
  <a href="<?php echo($base_url); ?>" class="moderator_link" onclick='return select_private_members()'><?php echo_html(text("ManageMembers")); ?></a>
  <?php endif; ?>

  <?php if($topic_data["is_private"] != 2 || $topic_data["user_id"] != $fmanager->get_user_id()): ?>
  <a href="<?php echo($base_url); ?>" class="moderator_link" onclick='return confirm_action("<?php echo_js(text("MsgConfirmLeaveTopic"), true); ?>", { topic_action: "leave_topic", topic: "<?php echo_js($tid); ?>", forum: "<?php echo_js($fid); ?>" })'><?php echo_html(text("LeaveTopic")); ?></a><br>
  <?php endif; ?>

<?php elseif($fmanager->is_admin() || $fmanager->is_forum_moderator($fid) || $fmanager->is_topic_moderator($tid)): ?>

<?php echo_html($fmanager->is_admin() ? text("Administrator") : text("Moderator")); ?>:<br>

<?php if(empty($_SESSION["show_deleted"])): ?>
<a href="<?php echo($base_url . $gotomsg_appendix); ?>&show_deleted=1&hash=<?php echo_html($_SESSION["hash"]); ?>" class="moderator_link"><?php echo_html(text("DisplayDeleted")); ?></a>
<?php else: ?>
<a href="<?php echo($base_url . $gotomsg_appendix); ?>&hide_deleted=1&hash=<?php echo_html($_SESSION["hash"]); ?>" class="moderator_link"><?php echo_html(text("HideDeleted")); ?></a>
<?php endif; ?>
...
<?php if($fmanager->is_topic_moderator($tid)): ?>
  ...
  <?php else: ?>
  <br> <a href="<?php echo($base_url); ?>" class="moderator_link" onclick='return do_action({ topic_action: "allow_guests", topic: "<?php echo_js($tid); ?>", forum: "<?php echo_js($fid); ?>" })'><?php echo_html(text("AllowGuests")); ?></a>
  <?php endif; ?>
  <?php endif; // no guests ?>
...
<?php else: ?>
  ...
  <br> <a href="<?php echo($base_url); ?>" class="moderator_link" onclick='return confirm_action("<?php echo_js(text("MsgConfirmPinTopic"), true); ?>", { topic_action: "pin_topic", topic: "<?php echo_js($tid); ?>", forum: "<?php echo_js($fid); ?>" })'><?php echo_html(text("PinTopic")); ?></a>
  <?php else: ?>
  <br> <a href="<?php echo($base_url); ?>" class="moderator_link" onclick='return do_action({ topic_action: "unpin_topic", topic: "<?php echo_js($tid); ?>", forum: "<?php echo_js($fid); ?>" })'><?php echo_html(text("UnpinTopic")); ?></a>
  <?php endif; ?>

  <?php if(empty($topic_data["deleted"])): ?>
  <br> <a href="<?php echo($base_url); ?>" class="moderator_link" onclick='return confirm_action_with_comment("<?php echo_js(text("MsgConfirmTopicDelete"), true); ?>", { topic_action: "delete_topic", topic: "<?php echo_js($tid); ?>", forum: "<?php echo_js($fid); ?>" });'><?php echo_html(text("DeleteTopic")); ?></a>
  <?php else: ?>
  <br> <a href="<?php echo($base_url); ?>" class="moderator_link" onclick='return do_action({ topic_action: "restore_topic", topic: "<?php echo_js($tid); ?>", forum: "<?php echo_js($fid); ?>" })'><?php echo_html(text("RestoreTopic")); ?></a>
  <?php endif; ?>

  <?php if(empty($topic_data["closed"])): ?>
  <br> <a href="<?php echo($base_url); ?>" class="moderator_link" onclick='return confirm_action("<?php echo_js(text("MsgConfirmTopicClose"), true); ?>", { topic_action: "close_topic", topic: "<?php echo_js($tid); ?>", forum: "<?php echo_js($fid); ?>" });'><?php echo_html(text("CloseTopic")); ?></a>
  <?php else: ?>
  <br> <a href="<?php echo($base_url); ?>" class="moderator_link" onclick='return do_action({ topic_action: "open_topic", topic: "<?php echo_js($tid); ?>", forum: "<?php echo_js($fid); ?>" })'><?php echo_html(text("OpenTopic")); ?></a>
  <?php endif; ?>
...
<a href="<?php echo($base_url); ?>" class="moderator_link" onclick="return toggle_forum_selection_area()"><?php echo_html(text("MoveTopic")); ?></a>
  <div id="forum_selection_area" class="forum_selection_area" style="display:none">
    <div style="position: absolute;right:2px;top:4px;cursor:pointer" onclick="toggle_forum_selection_area()"><img src="<?php echo($view_path); ?>images/cross.png" alt="<?php echo_html(text("Close")); ?>"></div>
  ...
  <br> <a href="<?php echo($base_url); ?>" class="moderator_link" onclick="return select_target_topic_for_merge()"><?php echo_html(text("MergeTopic")); ?></a>

  <?php if(empty($topic_data["profiled_topic"])): ?>
  <br> <a href="<?php echo($base_url); ?>" class="moderator_link" onclick='return confirm_action("<?php echo_js(text("MsgConfirmTurnProfiledModeOn"), true); ?>", { topic_action: "profiled_topic_on", topic: "<?php echo_js($tid); ?>", forum: "<?php echo_js($fid); ?>" })'><?php echo_html(text("TurnProfiledModeOn")); ?></a>
  <br> <a href="<?php echo($base_url); ?>" class="moderator_link" onclick='return confirm_action("<?php echo_js(text("MsgConfirmTurnBlogModeOn"), true); ?>", { topic_action: "blog_topic_on", topic: "<?php echo_js($tid); ?>", forum: "<?php echo_js($fid); ?>" })'><?php echo_html(text("TurnBlogModeOn")); ?></a>
  <?php elseif($topic_data["profiled_topic"] == 1): ?>
  <br> <a href="<?php echo($base_url); ?>" class="moderator_link" onclick='return do_action({ topic_action: "profiled_topic_off", topic: "<?php echo_js($tid); ?>", forum: "<?php echo_js($fid); ?>" })'><?php echo_html(text("TurnProfiledModeOff")); ?></a>
...
<tr>
<td id="no_posts_message" class="table_message"><?php echo_html(text("NoPosts")); ?></td>
</tr>
</table>
<?php endif; ?>
...
<form action="topic.php" id="search_blocked_user_area_form" method="post">
   ...
   <tr>
   <td>
   <select multiple name="found_users[]" onDblClick="Forum.moveSelectedItems(this.form.elements['found_users[]'], this.form.elements['selected_users[]'])">
   </select>
   </td>
   <td>
   <input type="button" class="standard_button" value="&gt;&gt;" onclick="Forum.moveSelectedItems(this.form.elements['found_users[]'], this.form.elements['selected_users[]']); this.form.elements['user_to_search'].value = '';">
   ...
   <td>
   <select multiple name="selected_users[]" onDblClick="Forum.moveSelectedItems(this.form.elements['selected_users[]'], this.form.elements['found_users[]'])">
   <?php
