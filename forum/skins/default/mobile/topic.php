...
<a href="<?php echo($base_url . $gotomsg_appendix); ?>&guest_posting_on=1<?php echo($fpage_appendix); ?>&hash=<?php echo_html($_SESSION["hash"]); ?>" onclick="check_actual_hash(this)" class="moderator_link"><?php echo_html(text("GuestPostingModeOn")); ?></a><br>
<?php else: ?>
<a href="<?php echo($base_url . $gotomsg_appendix); ?>&guest_posting_off=1<?php echo($fpage_appendix); ?>&hash=<?php echo_html($_SESSION["hash"]); ?>" onclick="check_actual_hash(this)" class="moderator_link"><?php echo_html(text("GuestPostingModeOff")); ?></a><br>
<?php endif; ?>
<?php endif; ?>
...
<a href="search.php?do_search=1&tid=<?php echo_html($tid); ?>&thematic_only=1&start_from=<?php echo($first_message); ?>"><?php echo_html(text("ThematicOnly")); ?></a> <br>
<?php endif; ?>    
