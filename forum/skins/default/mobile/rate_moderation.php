...
<tr>
<th><?php echo_html(text("ModerateRates")); ?></th>
</tr>
...
<tr>
<td>
<div class="smart_break"><a href="view_profile.php?uid=<?php echo_html($uid); ?>"><?php echo_html($udata["user_name"]); ?></a></div>

<table class="aux_table">
<tr>
<td>
<div class="forum_info">
<?php echo_html(text("Likes")); ?>:
<?php
$likes = 0;
...
<tr>
<td style="text-align: center"><?php echo_html(text("MsgUserNasNoRates")); ?></td>
</tr>
