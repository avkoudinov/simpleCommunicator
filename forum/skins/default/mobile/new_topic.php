...
<a href="<?php echo($url); ?>&guest_posting_on=1&hash=<?php echo_html($_SESSION["hash"]); ?>" onclick="check_actual_hash(this)" class="moderator_link"><?php echo_html(text("GuestPostingModeOn")); ?></a><br>
<?php else: ?>
<a href="<?php echo($url); ?>&guest_posting_off=1&hash=<?php echo_html($_SESSION["hash"]); ?>" onclick="check_actual_hash(this)" class="moderator_link"><?php echo_html(text("GuestPostingModeOff")); ?></a><br>
<?php endif; ?>
<?php endif; ?>
...
<tr>
<th id="post_message_caption"><?php echo_html($title); ?></th>
</tr>
...
<td class="enter_password"><a href="<?php echo($url); ?>" onclick="return show_author_password()"><?php echo_html(text("EnterPassword")); ?></a></td>
</tr>

<tr id="login_row1" style="display:none">
<td>
<div style="float:left"><?php echo_html(text("UserLogin")); ?>*:</div>
...
<tr id="login_row2" style="display:none">
<td>
<input type="text" id="user_login" name="user_login" value="" autocomplete="off" onkeypress="return handle_enter(event)">
</td>
</tr>

<tr id="password_row1" style="display:none">
<td>
<?php echo_html(text("Password")); ?>*:
</td>
</tr>
<tr id="password_row2" style="display:none">
<td><input type="password" id="user_password" name="user_password" value="" autocomplete="off"></td>
</tr>
<?php endif; ?>
...
<tr>
<th class="subheader"><?php echo_html(text("Message")); ?></th>
</tr>
...
<div class="toolbar_button_wrapper"><button class="toolbar_button" style="position:relative" type="button" onclick="return insert_tag('[sub]','[/sub]', 0)" tabindex="-1">X<sup style="position: absolute;top: 25px">2</sup></button></div>
...
<div class="toolbar_button_wrapper"><button class="toolbar_button" type="button" style="background: transparent url('<?php echo($view_path); ?>images/list.png') no-repeat center center;background-size: 70% 70%;" onclick="return insert_tag('[list]','[/list]', 0)" tabindex="-1">&nbsp;</button></div>
<div class="toolbar_button_wrapper"><button class="toolbar_button" type="button" style="background: transparent url('<?php echo($view_path); ?>images/nlist.png') no-repeat center center;background-size: 70% 70%;" onclick="return insert_tag('[nlist]','[/nlist]', 0)" tabindex="-1">&nbsp;</button></div>
...
<div class="toolbar_button_wrapper"><button class="toolbar_button" type="button" onclick="return insert_tag('[size=5]','[/size]', 0)" tabindex="-1">5</button></div>

<div class="toolbar_button_wrapper">
<button class="toolbar_button" type="button" style="background: transparent url('<?php echo($view_path); ?>images/color.png') no-repeat center center;background-size: 70% 70%;" onclick="return toggle_color_selection_area()" tabindex="-1">&nbsp;</button>
...
<div class="toolbar_button_wrapper">
<button class="toolbar_button" type="button" style="background: transparent url('<?php echo($view_path); ?>images/smile.png') no-repeat center center;background-size: 70% 70%;" onclick="return toggle_smile_selection_area()" tabindex="-1">&nbsp;</button>
</div>

<?php if($fmanager->is_logged_in() && !$fmanager->is_master_admin()): ?>
<div class="toolbar_button_wrapper"><button class="toolbar_button" type="button" style="background: transparent url('<?php echo($view_path); ?>images/gallery.png') no-repeat center center;background-size: 70% 70%;" onclick="return show_attachment_gallery()" tabindex="-1">&nbsp;</button></div>
<?php endif; ?>
...
<tr>
<td>
<input type="file" style="display: block" multiple="" data-placeholder="<?php echo_html(text("AddAttachment")); ?>" id="attachment" name="attachment" onchange="resizeFileInputControl(this);"> 
</td>
<td>
...
<?php for($i = 2; $i <= $fmanager->get_attachments_per_post(); $i++): ?>
  ...
  <tr>
  <td>
  <input type="file" style="display: block" multiple="" data-placeholder="<?php echo_html(text("AddAttachment")); ?>" id="attachment<?php echo $i; ?>" name="attachment<?php echo $i; ?>" onchange="resizeFileInputControl(this);"> 
  </td>
  <td>
...
<td>
   ...
   <tr>
     <td>
   <img style="display: block; float: left" class='captcha_picture' src='captcha/captcha.php?rnd=<?php echo(rand(1000, 9999)); ?>&session_var=captcha' id='captcha_picture' alt='Captcha' onclick='Forum.reload_captcha("captcha_picture", "captcha", "captcha_field")'>
     </td>
     <td>
     </td>
     <td>
   <input style="" type="text" id="captcha_field" name="captcha_field" class="captcha_field" value="" autocomplete="off" onkeypress="return handle_enter(event)">
     </td>
   </tr>
   </table>
</td>
...
<tr>
<td class="rules_agreemnt"><?php echo(text("PostRulesAgreement")); ?></td>
</tr>
