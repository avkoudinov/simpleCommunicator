...
/ <span class="topic_title_main"><?php echo_html(text("PrivacyPolicy")); ?></span>
</div>
...
<?php
if(file_exists($view_path . "lang/" . current_language() . "/privacy_policy.html")) 
{
  @include $view_path . "lang/" . current_language() . "/privacy_policy.html";
}
?>
</div>
