...
{
  var UldgewgaX = Math.floor(Math.random()*(window.innerWidth * 0.65));
  var UldgewgaY = Math.floor(Math.random()*(window.innerHeight * 0.65));
  
  var newX = img.offsetLeft + 300;
  var newY = img.offsetTop + 300;
  
  if (newX > Math.floor(window.innerWidth * 0.65)) newX = (newX - Math.floor(window.innerWidth * 0.65));
  if (newY > Math.floor(window.innerHeight * 0.65)) newY = (newY - Math.floor(window.innerHeight * 0.65));
