...
function reload_daily_activity_image(period)
{
  ...
  {
    img.style.opacity = "0.2";
    img.src = "ajax/user_activity_diagram.php?type=weekday&uid=<?php echo_html(reqvar("uid")); ?>&period=" + period + "&rnd=" + Math.random();
  }
}
...
<tr>
<th colspan="2"><?php echo_html(text("UserProfile")); ?></th>
</tr>
...
<tr>
<td><?php echo_html(text("RegistrationIPAddress")); ?>:</td>
<td>
...
<tr>
<td><?php echo_html(text("StrongIgnore")); ?>:</td>
<td>
<span class="number"><?php echo_html(empty($user_data["hide_ignored"]) ? text("No") : text("Yes")); ?></span>
</td>
</tr>
...
<?php
$moderator_caption = text("Actions");
?>
