...
$max_hits = max(round(1.1*max($y_hits)),50);
$max_exec_hits = max(round(1.1*max($y_exec_hits)),50);
$max_exec_times = max(round(1.1*max($y_exec_times)),50);

$max_rm_count = max(round(1.1*max($y_topic_rm_count)),round(1.1*max($y_forum_rm_count)),50);

//-----------------------------------------------------

$exec_times_graph = new Graph(938,320);

$exec_times_graph->SetMargin(70,70,20,40);
...
$exec_times_graph->yaxis->title->SetMargin(25,15,15,15);
...
$exec_times_graph->y2axis->title->SetMargin(25,15,15,15);
...
$line2 = new LinePlot($y_exec_hits, $x_exec_hits);
$exec_times_graph->AddY2($line2);
$line2->SetWeight("1"); 
$line2->SetStyle("solid"); 
$line2->SetColor("#14C814");
$label = utf8_to_nce(text("QueryExecCount"));
$line2->SetLegend($label);

$exec_times_graph->legend->SetLayout(LEGEND_HOR);
$exec_times_graph->legend->SetFont(FF_VERDANA,FS_NORMAL,8);
$exec_times_graph->legend->Pos(0.07,0.06,"left","bottom");
//-----------------------------------------------------
$read_marker_graph = new Graph(938,230);

$read_marker_graph->SetMargin(70,70,20,40);

$read_marker_graph->SetScale('datlin',0,$max_rm_count);
$read_marker_graph->SetY2Scale("lin",0,$max_rm_count);
...
$read_marker_graph->yaxis->title->SetMargin(25,15,15,15);

$read_marker_graph->y2axis->title->SetFont(FF_VERDANA,FS_NORMAL,8);
$read_marker_graph->y2axis->title->SetMargin(25,15,15,15);
...
$line->SetWeight("1"); 
$line->SetStyle("solid"); 
$line->SetColor("#FA2433");
$label = utf8_to_nce(text("TopicRMCount"));
$line->SetLegend($label);

$line2 = new LinePlot($y_forum_rm_count, $x_forum_rm_count);
$read_marker_graph->AddY2($line2);
$line2->SetWeight("1"); 
$line2->SetStyle("solid"); 
$line2->SetColor("#0078D7");
...
$read_marker_graph->legend->Pos(0.07,0.06,"left","bottom");
//-----------------------------------------------------
$hits_graph = new Graph(938,260);

$hits_graph->SetMargin(70,70,20,85);
...
$hits_graph->yaxis->title->SetMargin(25,15,15,15);
