...
define('NEW_CHECK_FREQUENCY', 60); // seconds
...
define('MAX_REQUESTS_PER_MINUTE', 90);
define('MAX_POSTS_PER_MINUTE', 10);
define('WAIT_TIME_AFTER_ATTACK', 5); // minutes
...
define('CONVERT_AMR_TO_MP3', 1); // requires avconv
define('CONVERT_AAC_TO_MP3', 1); // requires avconv
define('CONVERT_M4A_TO_MP3', 1); // requires avconv

define('SUPPORT_LATEX', 1); // requires texlive and dvipng

define('COMPRESS_PNG', 1); // requires pngquant
define('CONVERT_PNG_TO_JPG', 1); // requires imagemagic/convert
...
define('RO_DB_NAME', '');
define('RO_DB_USER', '');
define('RO_DB_PASSWORD', '');
define('RO_DB_PREFIX', 'v1');
...
define('SR_DB_NAME', '');
define('SR_DB_USER', '');
define('SR_DB_PASSWORD', '');
define('SR_DB_PREFIX', 'v1');

define('DB_FT_MIN_WORD_LEN', '3');

// Canonical URL
define('CANONICAL_DOMAIN', 'nosql.ru');

// Random avatars
define('RANDOM_AVATARS', 0);

//
define('REFRESH_TOR_IPS', 0);
define('MAX_STAT_REQUESTS_PER_MINUTE', 5);
